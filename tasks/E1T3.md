# E1T3 — /get <name> - Get Counter Value

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 TALLY

Implement /get command to return current counter value. Handle missing name and non-existent counters. Write tests to tests/specs/E1T3.json and add command to tests/commands.json. Implement in src/handlers/E1T3.ts.
