# E2T3 — Counter Limit Enforcement

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 TALLY

Enforce maximum 1000 counters per user. Return error when limit reached. Implement in src/handlers/E2T3.ts.
