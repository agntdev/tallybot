# E1T1 — /new <name> - Create Counter

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 TALLY

Implement /new command to create a counter with value 0. Validate name, handle errors (existing name, invalid name). Write tests to tests/specs/E1T1.json and add command to tests/commands.json. Implement in src/handlers/E1T1.ts.
