# E1T2 — /inc <name> [n] - Increment Counter

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 TALLY

Implement /inc command to increment a counter by n (default 1). Validate name and numeric delta. Handle missing counter and invalid input. Write tests to tests/specs/E1T2.json and add command to tests/command.json. Implement in src/handlers/E1T2.ts.
