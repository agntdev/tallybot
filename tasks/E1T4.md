# E1T4 — /reset <name> - Reset Counter

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 TALLY

Implement /reset command to set counter back to 0. Validate name and handle missing counters. Write tests to tests/specs/E1T4.json and add command to tests/commands.json. Implement in src/handlers/E1T4.ts.
