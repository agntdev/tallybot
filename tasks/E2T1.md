# E2T1 — Redis Schema Setup

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 TALLY

Implement Redis key schema: 'tallybot:{user_id}:counters' hash. Use HSETNX for creation, HINCRBY for increments. Implement in src/handlers/E2T1.ts.
