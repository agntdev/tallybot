# E1T5 — /list - List All Counters

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 TALLY

Implement /list command to show alphabetical list of counters. Handle empty state. Write tests to tests/specs/E1T5.json and add command to tests/commands.json. Implement in src/handlers/E1T5.ts.
